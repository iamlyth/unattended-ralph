...
for (const tool of ['read', 'edit', 'write']) {
  for (const path of ['src/CMakeLists.txt', 'build-check/test.log', '.factory/tests/legacy/CMakeLists.txt']) {
...
assert(trackedGuard.endsWith('.factory/tools/credential-guard.py'));
