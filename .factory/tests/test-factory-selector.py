...
class CanonicalPlanSelectionTest(unittest.TestCase):
    ...
    def test_canonical_plan_selects_first_runnable_pending(self) -> None:
        ...
        # Task 13 is complete at this plan revision, so Tasks 14 and 15 are
        # runnable; numeric priority then lexicographic identifier
        # deterministically picks Task 14.
        self.assertEqual(selection.task_id, 14)
        # Tasks 14 and 15 are runnable; every other unfinished task still has
        ...
        self.assertEqual(runnable, [14, 15])
...
class PurityAndLedgerBoundaryTest(unittest.TestCase):
    ...
    def test_selection_performs_no_io(self) -> None:
        ...
        plan = Plan.from_file(CANONICAL_PLAN)
        self.assertEqual(select_task(plan).task_id, 14)
...
class TrustedCliTest(unittest.TestCase):
    ...
    def test_cli_selects_canonical_next_task(self) -> None:
        ...
        self.assertEqual(result.stdout.strip(), "selected=14")
