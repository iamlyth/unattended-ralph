...
class CanonicalPlanSelectionTest(unittest.TestCase):
    ...
    def test_canonical_plan_selects_first_runnable_pending(self) -> None:
        ...
        # Task 10 is complete at this plan revision, so Tasks 11, 12, and 15
        # are runnable. Task 13 is also runnable from Task 1; numeric priority
        # then lexicographic identifier deterministically picks Task 11.
        self.assertEqual(selection.task_id, 11)
        # Tasks 11, 12, 13, and 15 are runnable; every other unfinished task
        ...
        self.assertEqual(runnable, [11, 12, 13, 15])
...
class PurityAndLedgerBoundaryTest(unittest.TestCase):
    ...
    def test_selection_performs_no_io(self) -> None:
        ...
        plan = Plan.from_file(CANONICAL_PLAN)
        self.assertEqual(select_task(plan).task_id, 11)
...
class TrustedCliTest(unittest.TestCase):
    ...
    def test_cli_selects_canonical_next_task(self) -> None:
        ...
        self.assertEqual(result.stdout.strip(), "selected=11")
