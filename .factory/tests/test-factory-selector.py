...
class CanonicalPlanSelectionTest(unittest.TestCase):
    ...
    def test_canonical_plan_selects_first_runnable_pending(self) -> None:
        ...
        # Task 12 is complete at this plan revision, so Task 15 is runnable.
        # Task 13 is also runnable from Task 1; numeric priority then
        # lexicographic identifier deterministically picks Task 13.
        self.assertEqual(selection.task_id, 13)
        # Tasks 13 and 15 are runnable; every other unfinished task still has
        ...
        self.assertEqual(runnable, [13, 15])
