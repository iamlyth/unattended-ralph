...
|----|--------|--------------|----------|------|
| PLAN-01 | §7 | missing | a UTF-8 BOM prefix must be rejected | Task 1 |
...
- Dependencies: None
- Priority: 3
- Scope: a BOM prefix is untrusted input.
- Acceptance criteria: the parser rejects it before any parsing.
...
- Status: pending
- Dependencies: Task 1
- Scope: fixture for the byte-order-mark test.
