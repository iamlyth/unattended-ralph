...
|----|--------|--------------|----------|------|
| PLAN-01 | §7 | missing | a matrix may not exceed the §24 registry | Task 1 |
| ZZZ-99 | §7 | missing | this ID is not part of the §24 registry | Task 1 |
...
- Dependencies: None
- Priority: 3
- Scope: a matrix with an extra ID is untrusted input.
- Acceptance criteria: the parser rejects the extra ID.
...
- Status: pending
- Dependencies: Task 1
- Scope: fixture for the extra-matrix-ID test.
