...
|----|--------|--------------|----------|------|
| PLAN-01 | §7 | missing | dependency ranges are bounded to the parsed task count | Task 1 |
...
- Status: pending
- Dependencies: Tasks 1-99999999999999999999
- Priority: 3
- Scope: an attacker-sized dependency range must not be materialized.
- Acceptance criteria: the parser rejects the oversized range.
...
- Status: pending
- Dependencies: Task 1
- Scope: fixture for the dependency-range-oversize test.
