...
|----|--------|--------------|----------|------|
| PLAN-01 | §1 | missing | unknown lifecycle status in the front matter | Task 1 |
...
- Dependencies: None
- Priority: 3
- Scope: one isolated task that parses.
- Acceptance criteria: the parser rejects an unknown lifecycle status.
