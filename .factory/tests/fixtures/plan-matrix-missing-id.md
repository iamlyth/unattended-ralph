...
|----|--------|--------------|----------|------|
| PLAN-01 | §7 | missing | a matrix must cover the entire §24 registry | Task 1 |
...
- Dependencies: None
- Priority: 3
- Scope: a matrix missing registry IDs is untrusted input.
- Acceptance criteria: the parser rejects the incomplete matrix.
...
- Status: pending
- Dependencies: Task 1
- Scope: fixture for the missing-matrix-ID test.
