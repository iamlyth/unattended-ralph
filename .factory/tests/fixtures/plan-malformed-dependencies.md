...
|----|--------|--------------|----------|------|
| PLAN-01 | §1 | missing | malformed dependency value | Task 1 |
...
- Priority: 3
- Scope: dependency items have one documented grammar.
- Acceptance criteria: the parser rejects the malformed value.
