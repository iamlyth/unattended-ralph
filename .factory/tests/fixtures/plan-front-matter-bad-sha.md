...
|----|--------|--------------|----------|------|
| PLAN-01 | §7 | missing | malformed front-matter commit | Task 1 |
...
- Dependencies: None
- Priority: 3
- Scope: spec commit must be a 40-character object ID.
- Acceptance criteria: the parser rejects the value.
...
- Status: pending
- Dependencies: Task 1
- Scope: fixture for the front-matter sha test.
