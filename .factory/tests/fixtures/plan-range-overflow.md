...
|----|--------|--------------|----------|------|
| PLAN-01 | §7 | missing | oversized endpoints convert to a bounded PlanError | Task 1 |
...
- Status: pending
- Dependencies: Tasks 1-9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
- Priority: 3
- Scope: an oversized integer endpoint must fail closed.
- Acceptance criteria: the parser rejects the out-of-range endpoint.
...
- Status: pending
- Dependencies: Task 1
- Scope: fixture for the range-overflow test.
