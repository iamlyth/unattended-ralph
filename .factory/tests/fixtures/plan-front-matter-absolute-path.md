---
spec_path: /etc/does-not-exist.md
...
|----|--------|--------------|----------|------|
| PLAN-01 | §7 | missing | absolute spec path | Task 1 |
...
- Dependencies: None
- Priority: 3
- Scope: spec path must be repository-relative.
- Acceptance criteria: the parser rejects an absolute path.
...
- Status: pending
- Dependencies: Task 1
- Scope: fixture for the front-matter path test.
