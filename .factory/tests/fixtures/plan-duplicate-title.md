...
|----|--------|--------------|----------|------|
| PLAN-01 | §7 | missing | a duplicated title is untrusted input | Task 1 |
...
- Dependencies: None
- Priority: 3
- Scope: the plan title must occur exactly once.
- Acceptance criteria: the parser rejects the duplicate title.
...
- Status: pending
- Dependencies: Task 1
- Scope: fixture for the duplicate-title test.
