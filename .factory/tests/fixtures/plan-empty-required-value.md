...
|----|--------|--------------|----------|------|
| PLAN-01 | §7 | missing | required field values must not be empty | Task 1 |
...
- Priority: 3
- Scope:
- Acceptance criteria: the parser rejects the empty required value.
...
- Status: pending
- Dependencies: Task 1
- Scope: fixture for the empty-required-value test.
