...
|----|--------|--------------|----------|------|
| PLAN-01 | §7 | missing | duplicate front-matter key | Task 1 |
...
- Dependencies: None
- Priority: 3
- Scope: each front-matter key appears exactly once.
...
- Status: pending
- Dependencies: Task 1
- Scope: fixture for the front-matter duplicate-key test.
