...
|----|--------|--------------|----------|------|
| PLAN-01 | §7 | missing | a complete lifecycle requires every task complete | Task 1 |
...
- Dependencies: None
- Priority: 3
- Scope: lifecycle status and task statuses must agree.
- Acceptance criteria: the parser rejects the inconsistent lifecycle.
...
- Status: pending
- Dependencies: Task 1
- Scope: fixture for the lifecycle-consistency test.
