...
|----|--------|--------------|----------|------|
| PLAN-01 | §7 | verified | a verified row must reference only completed tasks | Task 1 |
...
- Dependencies: None
- Priority: 3
- Scope: a verified row referencing a pending task is untrusted input.
- Acceptance criteria: the parser rejects the pending reference.
...
- Status: pending
- Dependencies: Task 1
- Scope: fixture for the verified-pending-reference test.
