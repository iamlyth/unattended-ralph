...
|----|--------|--------------|----------|------|
| PLAN-01 | §1 | missing | dependency on a nonexistent task | Task 1 |
...
- Dependencies: Task 9
- Priority: 3
- Scope: a dependency must reference an existing task.
...
- Status: pending
- Dependencies: Task 1
- Scope: fixture for the unknown-dependency test.
