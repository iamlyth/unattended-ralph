...
| ID | Spec § | Classification | Evidence |
|----|--------|--------------|----------|
| PLAN-01 | §7 | missing | malformed header row | Task 1 |
...
- Dependencies: None
- Priority: 3
- Scope: the matrix header must be exactly the documented header.
- Acceptance criteria: the parser rejects a malformed header.
...
- Status: pending
- Dependencies: Task 1
- Scope: fixture for the matrix header test.
