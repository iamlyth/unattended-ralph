...
|----|--------|--------------|----------|------|
| PLAN-01 | §7 | missing | spec path traversal is untrusted input | Task 1 |
...
- Dependencies: None
- Priority: 3
- Scope: a spec path must be repository-relative without traversal.
- Acceptance criteria: the parser rejects the traversal path.
