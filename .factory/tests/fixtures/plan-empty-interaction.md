...
- Dependencies: None
- Priority: 3
- Scope: empty interaction-boundary text is untrusted input.
- Acceptance criteria: the parser rejects the empty text.
...
- Status: pending
- Dependencies: Task 1
- Scope: fixture for the empty-interaction test.
