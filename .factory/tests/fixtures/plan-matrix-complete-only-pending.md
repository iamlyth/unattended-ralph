...
|----|--------|--------------|----------|------|
| TASK-01 | §7, §8 | missing | a non-verified row must own a non-complete task | Task 1 |
...
- Dependencies: None
- Priority: 3
- Scope: a completed task cannot own a non-verified conformance row alone.
- Acceptance criteria: the parser rejects the completed-only row.
...
- Status: pending
- Dependencies: Task 1
- Scope: fixture for the completed-only matrix-row test.
