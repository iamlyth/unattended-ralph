...
|----|--------|--------------|----------|------|
| PLAN-01 | §7 | missing | missing front-matter key | Task 1 |
...
- Dependencies: None
- Priority: 3
- Scope: all five front-matter keys are mandatory.
- Acceptance criteria: the parser rejects the missing key.
...
- Status: pending
- Dependencies: Task 1
- Scope: fixture for the front-matter test.
