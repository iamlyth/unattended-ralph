...
|----|--------|--------------|----------|------|
| PLAN-01 | §7 | missing | the final audit must depend on every other task | Task 1 |
...
- Dependencies: None
- Priority: 3
- Scope: the final audit must depend on every other task.
- Acceptance criteria: the parser rejects the missing dependency.
