...
|----|--------|--------------|----------|------|
| PLAN-01 | §7 | missing | matrix task ranges are bounded to the parsed task count | Tasks 1-99999999999999999999 |
...
- Dependencies: None
- Priority: 3
- Scope: an attacker-sized matrix range must not be materialized.
...
- Status: pending
- Dependencies: Task 1
- Scope: fixture for the matrix-range-oversize test.
