...
|----|--------|--------------|----------|------|
| PLAN-01 | §7 | missing | structured fields are single-line | Task 1 |
...
- Dependencies: None
- Priority: 3
- Scope: a continuation line on a structured field is untrusted input.
- Acceptance criteria: the parser rejects the continuation line.
...
- Status: pending
- Dependencies: Task 1
- Scope: fixture for the structured-field-continuation test.
