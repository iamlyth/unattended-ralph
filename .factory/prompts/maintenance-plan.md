...
Before requesting completion, run `./scripts/final-gate.sh --maintenance-planning`. Fix every reported deficiency; never rely on a prose review of the criteria or repeat a completion summary after the command fails.
