...
Library API::
    ...
    # The tool ships as .factory/tools/credential-guard.py (dash) for the CLI; load it
    # as a library by path or import it under its snake_case alias:
    import importlib.util
    spec = importlib.util.spec_from_file_location("credential_guard", ".factory/tools/credential-guard.py")
