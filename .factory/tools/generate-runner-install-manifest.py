...
REQUIRED = {
    ".factory/tools/install-factory-runner-v2.sh",
    ".factory/tools/factory-runner-root-bootstrap",
    ".factory/tools/factory-runner-broker.py",
    ".factory/tools/factory-runner-signer.py",
    ".factory/tools/factory-runner-server.py",
    ".factory/tools/factory_runner_policy.py",
    ".factory/tools/factory_runner_artifacts.py",
    ".factory/tools/factory_runner_authority.py",
    ".factory/tools/build-runner-probe-authority.py",
...
def build(root: pathlib.Path, revision: str) -> dict:
    ...
    return {"schema": SCHEMA, "commit": commit, "tree": tree,
            ...
            "installer": ".factory/tools/install-factory-runner-v2.sh",
            "authority_builder": ".factory/tools/build-runner-probe-authority.py",
