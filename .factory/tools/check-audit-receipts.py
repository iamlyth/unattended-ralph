...
- `[receipt: <path>]` for a coordinator-executed command recorded by
  `.factory/tools/machine-receipt.py`, or
...
`.factory/tools/check-factory-runner-evidence.py`, anchored at the campaign audit
...
def validate_manifest(root: Path, reference: str, expected_base: str) -> None:
    ...
    """
    helper = root / ".factory/tools/check-factory-runner-evidence.py"
