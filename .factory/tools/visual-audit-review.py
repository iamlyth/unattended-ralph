...
FRAMEWORK_SCRIPT_RELS = (
    ".factory/tools/visual-audit-review.py", ".factory/tools/visual-audit-provenance.py",
    ".factory/tools/visual-audit-capture.py", ".factory/tools/visual-audit-capture.sh",
    ".factory/tools/visual-audit-lease.py", ".factory/tools/visual-audit-probe.sh",
    ".factory/tools/visual-audit-review-sdk.mjs", ".factory/tools/check-visual-audit.py",
    ".factory/tools/visual-capture-driver.sh",
)
...
def validate_probe_receipt(section: dict, root: Path) -> None:
    ...
    if problem:
        die(f"probe receipt required before calibration: {problem}; run .factory/tools/visual-audit-probe.sh first")
    try:
...
def main() -> int:
    ...
    driver = resolve_path(root, section.get("sdk_driver", ".factory/tools/visual-audit-review-sdk.mjs"))
    if args.command == "run":
