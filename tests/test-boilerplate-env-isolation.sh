...
grep -q '^unset FACTORY_FINAL_GATE_ATTEST' tests/test-maintenance-planning-completion.sh || {
...
FACTORY_FINAL_GATE_ATTEST=1 ./tests/test-maintenance-planning-completion.sh || {
